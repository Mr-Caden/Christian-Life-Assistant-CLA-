...
export const BotIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M8.85 20.3q-2.15-2-2.15-4.575 0-1.475.75-3.25.75-1.775 2-3.825C10.7 6.4 11.075 4.7 12 3q.925 1.7 1.3 3.45.375 1.75 1.625 3.975 1.25 2.225 2 3.825.75 1.6.75 3.225 0 2.575-2.15 4.575-2.15 2-5.5 2t-5.15-2Z" />
  </svg>
);
